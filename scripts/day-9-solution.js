// NOT MY CODE
// https://github.com/sk1talets/advent-of-code/blob/main/2021/9/script.2.js

// Need to spend some time understanding this. Day 9 has fried my brain
...
function main() {
  const map = fs
    .readFileSync(`${__dirname}/../data/day-9.txt`)
    .toString()
    .split("\n")
